...
iCanToUse = contains(dataset.metadata.fileNameUser(:,1,1),'Aair','IgnoreCase',true) | ...
            contains(dataset.metadata.fileNameUser(:,1,1),'Auto Air','IgnoreCase',true) | ...
            contains(dataset.metadata.fileNameUser(:,1,1),'AutoAir','IgnoreCase',true) | ...
            contains(dataset.metadata.fileNameUser(:,1,1),'Auto_STD','IgnoreCase',true) | ...
            (count(dataset.metadata.fileNameUser(:,1,1),'air','IgnoreCase',true)==2 & contains(dataset.metadata.fileNameUser(:,1,1),'vs','IgnoreCase',true));
