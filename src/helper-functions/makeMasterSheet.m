...
iLja = contains(csCorrDataset.metadata.ID1(:,1,1),'LJA') | ...
       contains(csCorrDataset.metadata.fileNameUser(:,1,1),'LJA','IgnoreCase',true) | ...
       contains(csCorrDataset.metadata.fileNameUser(:,1,1),'LJ Air','IgnoreCase',true) | ...
       contains(csCorrDataset.metadata.fileNameUser(:,1,1),'La Jolla Air','IgnoreCase',true) | ...
       contains(csCorrDataset.metadata.fileNameUser(:,1,1),'LaJollaAir','IgnoreCase',true) | ...
       contains(csCorrDataset.metadata.fileNameUser(:,1,1),'LJ Aiir','IgnoreCase',true);
